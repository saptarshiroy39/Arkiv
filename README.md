...
|---------------------------------|------------------------------------------------------------------------------------|--------------------------------------|
| 📄 **Multi-Format Processing** | Upload & process PDF (including protected PDFs), Images, Word, Excel, CSV, PowerPoint, Markdown & TXT files | ***PyPDF2***, ***pdfplumber***, ***Pillow***, ***python-docx***, ***openpyxl***, ***python-pptx*** |
| 🖼️ **AI Vision Analysis**      | Analyze images using Gemini Vision for comprehensive content extraction            | ***Google Gemini Flash Latest***     |
| 🤖 **Contextual AI Q&A**       | RAG-powered question answering with responses grounded in your documents           | ***Google Gemini Flash Latest***     |
...
<p align="center">
  <a href="https://arkiv-app.onrender.com">Made</a> by Saptarshi Roy
</p>