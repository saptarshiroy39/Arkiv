...
|---------------------------------|------------------------------------------------------------------------------------|-----------------------------------------|
| 📄 **Multi-Format Processing** | Upload & process PDF (including protected), Images, Word, Excel, CSV, PowerPoint, Markdown & TXT files | ***PyPDF2***, ***pdfplumber***, ***Pillow***, ***python-docx***, ***openpyxl***, ***python-pptx*** |
